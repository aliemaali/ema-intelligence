  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col" style={{ borderLeft: `3px solid ${statusColor}` }}>
      <div className="p-4 flex-1 cursor-pointer" onClick={() => onOpen(investor.id)}>
        ...
        <div className="flex items-center gap-1.5 mb-3"><span className="px-2 py-0.5 rounded-md text-[10.5px] font-medium bg-slate-100 text-slate-600">{INVESTOR_FOCUS_LABELS[investor.focus]}</span><span className="text-[11.5px] text-slate-400">{investmentVolumeRange}</span></div>
