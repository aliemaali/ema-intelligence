...
export default async function DashboardPage() {
  ...
  return <div className="relative w-full max-w-full space-y-6 overflow-x-hidden pb-4 md:mx-auto md:max-w-[1480px]">
    <section className="relative isolate min-h-[34rem] overflow-hidden border-b border-blue-300/15 bg-[#06152f] sm:min-h-[32rem] md:min-h-[25rem] md:rounded-b-[2.4rem]">
      <div className="absolute inset-0"><Image src="/hero-dashboard-enterprise.jpg" alt="EMA Enterprise Portfolio aus BESS, Photovoltaik, Windkraft und Rechenzentrum" fill priority quality={95} sizes="(max-width: 767px) 100vw, (max-width: 1480px) 100vw, 1480px" className="object-cover object-[64%_38%] opacity-90 saturate-[1.02] sm:object-[58%_36%] md:object-[50%_32%]" /><div className="absolute inset-0 bg-gradient-to-b from-[#020b1d]/35 via-[#071a38]/45 to-[#020b1d]/95 md:bg-gradient-to-r md:from-[#020b1d]/90 md:via-[#071a38]/60 md:to-[#102c62]/20" /><div className="ema-glow-pulse absolute -left-16 top-1/3 h-64 w-64 rounded-full bg-[#77ed3b]/20 blur-[85px]" /><div className="ema-glow-pulse absolute -right-12 top-8 h-72 w-72 rounded-full bg-blue-500/24 blur-[95px]" /></div>
      <div className="relative z-10 flex min-h-[34rem] items-end px-5 pb-8 pt-24 sm:min-h-[32rem] sm:items-center sm:pb-0 sm:pt-0 md:min-h-[25rem] md:px-10"><div className="max-w-2xl"><div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#071a38]/68 px-3 py-1.5 text-white shadow-[0_0_24px_rgba(92,184,0,.12)] backdrop-blur-xl"><span className="h-2 w-2 rounded-full bg-[#7bed3e] shadow-[0_0_15px_rgba(123,237,62,.9)]" /><TimeGreeting /></div><h1 className="mt-5 text-4xl font-extrabold tracking-tight text-white md:text-5xl">Willkommen zurück,<br /><span className="bg-gradient-to-r from-[#8df24f] to-[#57a9ff] bg-clip-text text-transparent">{firstName}</span>{' '}👋</h1><p className="mt-4 max-w-xl text-slate-200">Dein Portfolio, deine Projekte und alle wichtigen Aktivitäten auf einen Blick.</p><div className="mt-7 flex flex-wrap gap-3"><Link href="/projects/new" className="rounded-2xl bg-gradient-to-r from-[#65c91d] to-[#82e33e] px-5 py-3 font-extrabold text-[#07142F] shadow-[0_12px_34px_rgba(108,224,44,.26)]">+ Neues Projekt</Link><Link href="/projects" className="rounded-2xl border border-blue-200/20 bg-blue-300/10 px-5 py-3 font-extrabold text-white shadow-[0_12px_32px_rgba(28,79,204,.18)] backdrop-blur-xl">Alle Projekte <ArrowRight className="inline h-4 w-4" /></Link></div></div></div>
    </section>
